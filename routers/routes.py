...
dashboardRoutes.add_url_rule("/add-products", view_func=product.add_product, methods=["GET","POST"])
dashboardRoutes.add_url_rule("/edit-products/<code>", view_func=product.edit_product, methods=["GET","POST"])
